...
describe('NgxGalleryImageComponent', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [NgxGalleryHelperService, Renderer2, { provide: HAMMER_GESTURE_CONFIG, useClass: CustomHammerConfig }]
    ...
    comp.images = [
      new NgxGalleryOrderedImage({ src: 'image-1.jpg', index: 0 }),
